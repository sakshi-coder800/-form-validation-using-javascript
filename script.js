...
function sbmt() {
    ...
    else if (b == "") { document.getElementById("sbmt_btn").disabled = true; }

    else if (c == "") { document.getElementById("sbmt_btn").disabled = true; }

    else if (d == "") { document.getElementById("sbmt_btn").disabled = true; }

    else if (e == "") { document.getElementById("sbmt_btn").disabled = true; }

    else if (f == "") { document.getElementById("sbmt_btn").disabled = true; }

    else if (g == "") { document.getElementById("sbmt_btn").disabled = true; }
